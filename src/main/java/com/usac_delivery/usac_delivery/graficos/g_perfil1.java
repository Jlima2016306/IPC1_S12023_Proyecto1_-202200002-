 ...
 * @author Julio Lima
 */
public class g_perfil1 extends javax.swing.JFrame {

    /**
     * Creates new form g_registrar
     */

    static boolean llaveCorreo = true;
    static boolean llaveNombre =true;
    static boolean llaveApellido =true;
    static boolean llavePass =true;
    static boolean llaveDPI =true;
    static boolean llaveFDN =true;
    static boolean llaveAlias =true;
    static boolean llaveFoto =true;
    static boolean llavetelefono =true;
    ...
    public g_perfil1() {
        ...
        String[] nacionalidades = {  "Guatemalteca","Hondureña"};
        ...
        jTextField1.setText(usuarios.get(0).getP_correo());
        jTextField2.setText(usuarios.get(0).getP_nombre());
        jTextField3.setText(usuarios.get(0).getP_apellido());
        jPasswordField1.setText(usuarios.get(0).getP_password());
        jFormattedTextField2.setText(usuarios.get(0).getP_DPI());
        jFormattedTextField1.setText(usuarios.get(0).getP_fechaDeNacimiento());
        jComboBox1.setSelectedItem(usuarios.get(0).getP_genero());
        jComboBox2.setSelectedItem(usuarios.get(0).getP_nacionalidad());
        jTextField7.setText(usuarios.get(0).getP_alias());
        jTextField8.setText(usuarios.get(0).getFoto());
        jFormattedTextField3.setText(""+usuarios.get(0).getP_telefono());
        jComboBox3.setSelectedIndex(usuarios.get(0).getP_rol()-1);
        if(usuarios.get(0).getP_idKiosko()!=0){
            jComboBox4.setSelectedIndex(usuarios.get(0).getP_idKiosko());
    ...
    private void initComponents() {
        ...
        jLabel17.setText("¡Acción realizada!");
        ...
        jButton2.setText("borrar cuenta");
        ...
        jButton1.setText("Confirmar Edición");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1. Rol Usuario", "2. Rol Kiosko" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        valor = Controlador_Usuario.editarUsuario(jTextField1.getText(),jPasswordField1.getText(),jTextField2.getText(),jTextField3.getText(),jFormattedTextField2.getText(),jFormattedTextField1.getText(),jComboBox1.getSelectedItem().toString() ,jComboBox2.getSelectedItem().toString(),jTextField7.getText(),Integer.parseInt(jFormattedTextField3.getText()),jComboBox3.getSelectedIndex()+1,jTextField8.getText(),idKiosko,usuarios.get(0).getP_id());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(g_perfil1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
